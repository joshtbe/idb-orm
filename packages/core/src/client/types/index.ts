...
export type GetStructure<N extends string, C extends Dict> =
    C[N] extends Model<N, infer F, any>
...
> {
    ...
    deleteFirst(
        where?: WhereObject<ExtractFields<C[Name]>, C>,
    ): Promise<boolean>;
    deleteMany(where: WhereObject<ExtractFields<C[Name]>, C>): Promise<number>;
